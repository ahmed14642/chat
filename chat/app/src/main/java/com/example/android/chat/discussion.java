 ...
 */
public class discussion extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    class discussionAdapter extends CursorAdapter {

        LayoutInflater mInflater;
        public discussionAdapter(Context context, Cursor c) {
            super(context, c);
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            View v = mInflater.inflate(R.layout.discussion1, parent, false);
            return v;
        }
